...
<section class="py-3 text-light footer-widget border-bottom" style="border-color: #3d3d46 !important; background-color: #2a4066 !important;">
    <div class="container">
        <!-- footer logo -->
        <div class="mt-3 mb-4">
...
@endphp
<section class="py-lg-3 text-light footer-widget" style="background-color: #2a4066 !important;">
    ...
    <div class="d-lg-none bg-transparent">
        ...
        <div class="aiz-accordion-wrap bg-black">
            ...
            <div class="aiz-accordion-panel bg-transparent" style="background-color: #2a4066 !important;">
                <div class="container">
