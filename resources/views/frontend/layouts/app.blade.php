...
<head>
    ...
    <style>
        :root {
    --primary: #C8102E; /* الأحمر الأساسي - هوية Nashmi */
    --hov-primary: #a50d25; 
    --soft-primary: rgba(200, 16, 46, 0.15);

    --secondary-base: #007A3D; /* الأخضر (لون مكمل من العلم الأردني) */
    --hov-secondary-base: #006233;
    --soft-secondary-base: rgba(0, 122, 61, 0.15);
    ...
    --blue: #0052A5; /* الأزرق الغامق من شعار الأردن */
    --hov-blue: #003f7d;
    --soft-blue: rgba(0, 82, 165, 0.15);
}

        body{
            font-family: 'Public Sans', sans-serif;
            font-weight: 400;
            background-image: url('{{ static_asset('assets/img/bg-cover.png') }}');
        }
        body,*,
        html {
...
<body>
    <img src="{{ static_asset('assets/img/bg-cover.png') }}" style="position: fixed;top: -37px;width: 100%;" alt="Image">
    <!-- aiz-main-wrapper -->
